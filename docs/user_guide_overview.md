...
You can use the sidebar on the left for navigation or the tiles below to jump to the section you are interested in.
        ...
        <div class="grid cards" markdown>
            ...
            <a class="card-link" href="../admin">
                <article>
                    ...
                    <p>User Management. API. Logs. </p>
                    <p><strong>See administration →</strong></p>
                </article>
            </a>
            ...
            <a class="card-link" href=../test_case_repository>
                <article>
                    <h3>Test case repository</h3>
                    <p>Overview of test cases management </p>
                    <p><strong>Learn more →</strong></p>
                </article>
            </a>

            <a class="card-link" href="../test_script_and_test_data">
                <article>
                    <h3>Test script definition</h3>
                    <p>Guide on how to write test cases </p>
            ...
            <a class="card-link" href="../analytics">
                <article>
                    <h3>Analytics</h3>
                    <p>Overview of Analytics page</p>
                    <p><strong>See overview →</strong></p>
                </article>
            </a>
            <a class="card-link" href="../reports">
                <article>
                    <h3>Reports</h3>
                    <p>How to use the reporting features</p>
                    <p><strong>See guide →</strong></p>
                </article>
            </a>
            <a class="card-link" href="../glossary_of_terms">
                <article>
                    <h3>Frequently used terms and metatypes</h3>
                    <p>Overview of terms and metatypes</p>
                    <p><strong>See overview →</strong></p>
                </article>
            </a>
        </div>
